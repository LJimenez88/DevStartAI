...
def build_env_content(db_engine: str, use_docker: bool) -> str:
    """
    Build the contents of the generated .env file based on:
    - db_engine: "none" | "postgres" | "sqlite"
    - use_docker: whether the user selected Docker
    """
    lines: List[str] = []
...
def scaffold_project(body: ScaffoldRequest):
    ...
    try:
        env_text = build_env_content(body.dbEngine, body.includeDocker)
